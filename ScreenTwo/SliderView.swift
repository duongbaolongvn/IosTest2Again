...
class SliderView: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        line.colors = [startLineColor.cgColor, endLineColor.cgColor]
        ...
        circle.fillColor = startLineColor.getMiddleGrandientColor(endLineColor, percentage: value).cgColor
...
extension UIColor {
    func getMiddleGrandientColor(_ color: UIColor, percentage: CGFloat) -> UIColor {
